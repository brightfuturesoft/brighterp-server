...
const testimonials_collection = client.db('ecommerce').collection("testimonials");
...
achievements_collection, testimonials_collection, newsletter_collection, seo_collection};
