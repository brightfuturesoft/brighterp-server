...
const { size_collection } = require("../../../collection/collections/item/items");
...
const get_size = async (req, res, next) => {
      try {
            ...
            const sizes = await size_collection.find({ workspace_id, delete: { $ne: true } }).toArray();
            return response_sender({
                  res,
                  status_code: 200,
                  error: false,
...
module.exports = { create_size, get_size, update_size, delete_size }
