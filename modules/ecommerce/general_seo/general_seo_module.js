...
const { seo_collection } = require("../../../collection/collections/ecommerce/ecommerce");

// GET SEO Records
const get_seo = async (req, res, next) => {
  try {
    ...
    const seo_records = await seo_collection.find({ workspace_id, delete: { $ne: true } }).toArray();
    return response_sender({
      res,
      status_code: 200,
      error: false,
...
// CREATE SEO Record
const create_seo = async (req, res, next) => {
  try {
    ...
    const result = await seo_collection.insertOne(updated_data);
...
// UPDATE SEO Record
const update_seo = async (req, res, next) => {
  try {
    const input_data = req.body;
    const workspace_id = req.headers.workspace_id;
    ...
    const result = await seo_collection.updateOne(
...
const delete_seo = async (req, res, next) => {
  try {
    const input_data = req.body;
    const workspace_id = req.headers.workspace_id;
